...
import utils.sampler as sampler_module
from utils import layers, evaluation
...
def train(dataset, args):
    ...
    torch.save(h_item, 'data/h_item')
if __name__ == '__main__':
    # Arguments
    parser = argparse.ArgumentParser()
    parser.add_argument('dataset_path', type=str, default='data/full_graph')
